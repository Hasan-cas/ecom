...
def create_order_from_cart(client_token, customer_data):
    """Converts CartItems into a permanent Order and OrderItems"""
    try:
        ...
        db.session.flush()  # Generates order_id before committing
        ...
        for item in cart_items:
            order_item = OrderItem(
                ...
                size=item.size  # CRITICAL: Bridges the variant data
            )
